    ...
    <tr>
      <td width="450px" valign="top">
        ...
        <div class="divider-right" style="width: 484px; float: left">
          <h2 class="title">
            <span id="ctl00_cphRoblox_rbxUserPane_lUserRobloxURL"><?=$profileInfo->Name?>'s Profile</span>
          </h2>
                ...
                <div>
                  <center>
                    ...
                    <a id="ctl00_cphRoblox_rbxUserPane_AvatarImage" disabled="disabled" class=" notranslate" title="<?=$user->Name?>" class=" notranslate" onclick="return false" style="display:inline-block;height:200px;width:200px;">
                      <div class="roblox-avatar-image image-medium" data-user-id="<?=$profileInfo->Id?>" data-image-size="custom" data-image-size-x="200" data-image-size-y="200" data-no-click="true" border="0" onerror="return Roblox.Controls.Image.OnError(this)" alt="<?=$user->Name?>"></div>
                    </a>
                    <br>
                    ...
                    <div id="ProfileButtons" style="<?php if($selfProfile) { echo "display: none; "; }?>margin: 10px auto; width: 256px;">
                      <?php if(!$selfProfile) { ?>
                      <a id="FriendButton" class="GrayButton <?php if(!SESSION){ echo "Disabled"; } ?>" href="/My/FriendInvitation.aspx?RecipientID=<?=$profileInfo->Id?>">Send Friend Request</a>
          ...
          <div class="divider-bottom" style="padding-bottom: 20px">
            <table class="statsTable">
              ...
              <tr>
                ...
                <td class="statsValue"><span id="ctl00_cphRoblox_rbxUserStatisticsPane_lPlaceVisitsStatistics" class="notranslate">24,166,265</span></td>
              </tr>
              <tr>
          ...
          <div class="divider-bottom" style="padding-bottom: 20px">
            <div>
              <h2 class="title" style="display:block;float: left;">
                <span class="notranslate"><?=$profileInfo->Name?></span>'s Sets
              </h2>
        ...
        <div class="divider-left" style="width: 484px; float: left; position: relative; left: -1px">
              ...
              <div id="ctl00_cphRoblox_rbxUserPlacesPane_pnlUserPlaces">
                <div id="UserPlaces" style="overflow: hidden">
                  <div id="accordion" class="accordion">
                    <?php 
                    if(!$gamesQuery->rowCount()){ echo $profileInfo->Name." does not have any ROBLONIUM places."; }
                    while($row = $gamesQuery->fetch(PDO::FETCH_OBJ)){ 
                    ?>
                    <div>
          ...
          <div style="padding-left: 20px" class="divider-bottom">
            <div style="margin: 12px 0 20px; overflow:visible">
              <h2 style="float: left"><?=$profileInfo->Name?>'s Friends</h2>
            ...
            <div style="padding-top: 50px">
              <div id="ctl00_cphRoblox_rbxFriendsPane_pNoResults">
                <p><span id="ctl00_cphRoblox_rbxFriendsPane_lNoResults"><?=$profileInfo->Name?> does not have any ROBLONIUM friends.</span></p>
              </div>
            </div>
          </div>
